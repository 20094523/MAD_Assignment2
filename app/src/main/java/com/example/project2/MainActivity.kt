    ...
    NavHost(navController = navController, startDestination = "main_screen") {
        ...
        composable("add_item_screen") {
            BackgroundColorModifier { modifier ->
                AddItemScreen(
                    navController = navController,
                    groceryViewModel = groceryViewModel, // Pass groceryViewModel here
                    modifier = modifier
                )
            }
        }
...
fun AddItemScreen(
    ...
    GroceryForm(
        ...
        onSubmit = { name, amount, imageUri ->
            groceryViewModel.insert(Grocery(name = name, amount = amount.toInt(), imageUri = imageUri?.toString()))
...
fun EditItemScreen(
    ...
    GroceryForm(
        ...
        initialImageUri = grocery.imageUri?.let { Uri.parse(it) },
        onSubmit = { name, amount, imageUri ->
            groceryViewModel.update(Grocery(id = grocery.id, name = name, amount = amount.toInt(), imageUri = imageUri?.toString()))
            navController.popBackStack()
        },
        onImagePicked = {},
        modifier = modifier
